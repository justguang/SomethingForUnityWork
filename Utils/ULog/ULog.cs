...
namespace RGuang.Utils
{
    ...
    public static class ULogExtensionMethods
    {
        ...
        {
            ULog.Log(string.Format(log, args));
        }
        /// <summary>
        /// 打印普通日志
        /// </summary>
        ...
        /// <param name="log">要打印的内容</param>
        /// <param name="args">格式化的参数</param>
        public static void ColorLog(this object obj, ULogColor color, string log, params object[] args)
        {
            ULog.ColorLog(color, string.Format(log, args));
        }
        /// <summary>
        /// 打印带颜色的日志
        /// </summary>
        /// <param name="color">设置内容显示的颜色</param>
        /// <param name="log">要打印的内容</param>
        public static void ColorLog(this object obj, ULogColor color, object log)
        {
            ULog.ColorLog(color, log);
        }
        ...
        {
            ULog.Warn(string.Format(log, args));
        }
        /// <summary>
        /// 打印警告日志
        /// </summary>
        ...
        {
            ULog.Error(string.Format(log, args));
        }
        /// <summary>
        /// 打印错误日志
        /// </summary>
        ...
        {
            ULog.Trace(string.Format(log, args));
        }
        /// <summary>
        /// 打印堆栈
        /// </summary>
